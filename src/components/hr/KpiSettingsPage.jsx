...
import PerformanceAutomationSettingsPanel from "../performance/PerformanceAutomationSettingsPanel";
...
export default function KpiSettingsPage({ currentCompany, can }) {
  ...
  return (
    <div className="space-y-5" dir="rtl">
      ...
      <PerformanceAutomationSettingsPanel companyId={companyId} canEdit={canEdit} />
    </div>
  );
}
