...
function DailyOperationsPageEnhanced({ employees = [], currentUser, currentCompany, can }) {
  const localDateOnly = (date = new Date()) => `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, "0")}-${String(date.getDate()).padStart(2, "0")}`;
