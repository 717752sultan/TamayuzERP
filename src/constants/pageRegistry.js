...
const navigationMetadata = {
  ...
  daily_operations_reports: { navGroupKey: "hr_attendance", navGroupLabel: "الحضور والدوام", navGroupOrder: 3, navItemOrder: 1.5 },
  ...
  overtime_import_export: { navGroupKey: "hr_attendance", navGroupLabel: "الحضور والدوام", navGroupOrder: 3, navItemOrder: 4.5 },
  attendance_dashboard: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 1, navLabel: "لوحة حساب الدوام" },
  attendance_records: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 2, navLabel: "تسجيل حضور وانصراف" },
  bulk_attendance: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 3, navLabel: "تحضير جماعي" },
  attendance_requests: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 4, navLabel: "معالجة طلبات العمل" },
  working_hours_report: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 5, navLabel: "تقرير ساعات الاشتغال" },
  attendance_in_out_report: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 6, navLabel: "تقرير الحضور والانصراف" },
  monthly_attendance_report: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 7, navLabel: "تقرير الحضور الشهري" },
  attendance_period_settings: { navGroupKey: "attendance_calculation", navGroupLabel: "حساب الدوام", navGroupOrder: 3, navItemOrder: 8, navLabel: "إعدادات فترات الدوام" },
  ...
  monthly_employee_targets: { navGroupKey: "hr_performance", navGroupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", navGroupOrder: 6, navItemOrder: 4 },
  branch_targets: { navGroupKey: "hr_performance", navGroupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", navGroupOrder: 6, navItemOrder: 5 },
  attendance_kpi_rules: { navGroupKey: "hr_performance", navGroupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", navGroupOrder: 6, navItemOrder: 6 },
  incentive_exclusions: { navGroupKey: "hr_performance", navGroupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", navGroupOrder: 6, navItemOrder: 11 },
  performance_process_guide: { navGroupKey: "hr_performance", navGroupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", navGroupOrder: 6, navItemOrder: 12 },
  performance_kpi_scores: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 4 },
  kpi_settings: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 5 },
  ...
  inventory_items_import_export: { navGroupKey: "inventory_items", navGroupLabel: "الأصناف", navGroupOrder: 2, navItemOrder: 2 },
  ...
  assets_1: { navGroupKey: "assets_dashboard", navGroupLabel: "لوحة الأصول", navGroupOrder: 1, navItemOrder: 1 },
  assets_2: { navGroupKey: "assets_registry", navGroupLabel: "سجل الأصول", navGroupOrder: 2, navItemOrder: 1 },
  assets_3: { navGroupKey: "assets_setup", navGroupLabel: "إعدادات الأصول", navGroupOrder: 3, navItemOrder: 1 },
  assets_4: { navGroupKey: "assets_custodies", navGroupLabel: "العهد", navGroupOrder: 4, navItemOrder: 1 },
  assets_5: { navGroupKey: "assets_finance", navGroupLabel: "الإهلاك والقيمة", navGroupOrder: 5, navItemOrder: 1 },
  assets_depreciation_tools: { navGroupKey: "assets_finance", navGroupLabel: "الإهلاك والقيمة", navGroupOrder: 5, navItemOrder: 2 },
  assets_6: { navGroupKey: "assets_maintenance", navGroupLabel: "الصيانة", navGroupOrder: 6, navItemOrder: 1 },
  assets_7: { navGroupKey: "assets_movements", navGroupLabel: "حركات الأصول", navGroupOrder: 7, navItemOrder: 1 },
  assets_8: { navGroupKey: "assets_movements", navGroupLabel: "حركات الأصول", navGroupOrder: 7, navItemOrder: 2 },
  assets_9: { navGroupKey: "assets_reports", navGroupLabel: "تقارير الأصول", navGroupOrder: 8, navItemOrder: 1 },
  assets_import_export: { navGroupKey: "assets_reports", navGroupLabel: "تقارير الأصول", navGroupOrder: 8, navItemOrder: 2 },
...
const erpRegistryPages = [
  ...
  ["inventory_items_import_export", "استيراد وتصدير الأصناف", "inventory", "inventory_items_import_export", "inventory.items.import_export", ["can_view", "can_import", "can_export", "can_print"], "active"],
  ...
  ...[
    ["assets_1", "لوحة الأصول", "assets.dashboard", reportActions],
    ["assets_2", "سجل الأصول", "assets.registry", ["can_view", "can_create", "can_edit", "can_delete", "can_import", "can_export", "can_print", "can_manage", "can_view_financial"]],
    ["assets_3", "تصنيفات الأصول", "assets.categories", settingsActions],
    ["assets_4", "العهد", "assets.custodies", approvalActions],
    ["assets_5", "الإهلاك", "assets.depreciation", financialActions],
    ["assets_depreciation_tools", "حاسبة وجدول الإهلاك", "assets.depreciation.calculate", ["can_view", "can_export", "can_print", "can_manage"]],
    ["assets_6", "الصيانة", "assets.maintenance", approvalActions],
    ["assets_7", "نقل الأصول", "assets.transfers", approvalActions],
    ["assets_8", "استبعاد الأصول", "assets.disposals", approvalActions],
    ["assets_9", "تقارير الأصول", "assets.reports", reportActions],
    ["assets_import_export", "استيراد وتصدير الأصول", "assets.import_export", ["can_view", "can_import", "can_export", "can_print"]],
...
export const pageRegistry = [
  ...
  { key: "overtime_import_export", label: "استيراد وتصدير العمل الإضافي", aliases: ["استيراد الدوام الإضافي"], icon: "FileSpreadsheet", group: "hr", groupLabel: "موارد بشرية", permissionKey: "hr.overtime.import_export", moduleKey: "overtime_import_export", order: 13.5, isOfficialPage: true, isDuplicateAllowed: false },
  ...
  { key: "daily_operations_reports", label: "تقارير العمليات اليومية", aliases: ["تقرير العمليات اليومية"], icon: "FileBarChart", group: "core", groupLabel: "أساسية", permissionKey: "hr.daily_operations.reports.view", moduleKey: "daily_operations_reports", order: 16.5, isOfficialPage: true, isDuplicateAllowed: false },
  ...
  { key: "monthly_employee_targets", label: "\u0623\u0647\u062f\u0627\u0641 \u0627\u0644\u0634\u0647\u0631", icon: "Target", group: "performance", groupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621", permissionKey: "performance_standards", moduleKey: "performance_standards", order: 17.2, isOfficialPage: true },
  { key: "branch_targets", label: "\u0623\u0647\u062f\u0627\u0641 \u0627\u0644\u0641\u0631\u0648\u0639", icon: "Building2", group: "performance", groupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621", permissionKey: "performance_standards", moduleKey: "performance_standards", order: 17.3, isOfficialPage: true },
  { key: "attendance_kpi_rules", label: "\u0642\u0648\u0627\u0639\u062f \u0627\u0644\u062d\u0636\u0648\u0631 \u0648\u0627\u0644\u0627\u0646\u0636\u0628\u0627\u0637", icon: "CalendarCheck", group: "performance", groupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621", permissionKey: "performance_standards", moduleKey: "performance_standards", order: 17.4, isOfficialPage: true },
  { key: "incentive_exclusions", label: "\u0627\u0633\u062a\u062b\u0646\u0627\u0621\u0627\u062a \u0627\u0644\u062d\u0648\u0627\u0641\u0632", icon: "Ban", group: "performance", groupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621", permissionKey: "incentives", moduleKey: "incentives", order: 18.8, isOfficialPage: true },
  { key: "performance_process_guide", label: "\u0634\u0631\u062d \u0622\u0644\u064a\u0629 \u0627\u0644\u062a\u0642\u064a\u064a\u0645 \u0648\u0627\u0644\u062d\u0648\u0627\u0641\u0632", icon: "BookOpen", group: "performance", groupLabel: "\u0627\u0644\u0623\u062f\u0627\u0621", permissionKey: "incentives", moduleKey: "incentives", order: 18.9, isOfficialPage: true },
  ...
  { key: "kpi_settings", label: "إعدادات KPI", aliases: ["إعدادات مؤشرات الأداء"], icon: "Settings", group: "performance", groupLabel: "الأداء", permissionKey: "kpi_settings", moduleKey: "hr", order: 18.5, isOfficialPage: true, isDuplicateAllowed: false, status: "active", defaultEnabled: true },
  ...
  { key: "attendance_dashboard", label: "لوحة حساب الدوام", aliases: ["حساب الدوام"], icon: "Clock3", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_records", moduleKey: "attendance", order: 107, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "attendance_records", label: "تسجيل حضور وانصراف", aliases: ["سجل الحضور", "الحضور والانصراف"], icon: "CalendarCheck", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_records", moduleKey: "attendance", order: 108, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "bulk_attendance", label: "تحضير جماعي", aliases: ["التحضير الجماعي"], icon: "Users", group: "hr", groupLabel: "موارد بشرية", permissionKey: "bulk_attendance", moduleKey: "attendance", order: 109, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "attendance_requests", label: "معالجة طلبات العمل", aliases: ["طلبات الحضور"], icon: "ClipboardList", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_requests", moduleKey: "attendance", order: 110, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "working_hours_report", label: "تقرير ساعات الاشتغال", aliases: ["ساعات العمل"], icon: "FileBarChart", group: "hr", groupLabel: "موارد بشرية", permissionKey: "working_hours_report", moduleKey: "attendance", order: 111, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "attendance_in_out_report", label: "تقرير الحضور والانصراف", aliases: ["حركة الحضور"], icon: "FileBarChart", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_in_out_report", moduleKey: "attendance", order: 112, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "monthly_attendance_report", label: "تقرير الحضور الشهري", aliases: ["كشف الحضور الشهري"], icon: "CalendarDays", group: "hr", groupLabel: "موارد بشرية", permissionKey: "monthly_attendance_report", moduleKey: "attendance", order: 113, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
  { key: "attendance_period_settings", label: "إعدادات فترات الدوام", aliases: ["فترات الدوام"], icon: "Settings", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_period_settings", moduleKey: "attendance", order: 114, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
