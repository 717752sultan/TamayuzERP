...
export const pageRegistry = [
  ...
  { key: "platform_company_entitlements", label: "إدارة اشتراكات الشركات", aliases: ["صلاحيات وخطط الشركات"], icon: "Wallet", group: "system", groupLabel: "النظام", permissionKey: "platform.company_entitlements", moduleKey: "system", moduleLabel: "النظام", routeKey: "platform_company_entitlements", order: 24, isOfficialPage: true, isDuplicateAllowed: false, status: "active", defaultEnabled: true },
  { key: "system_settings", label: "الإعدادات العامة", aliases: ["إعدادات النظام العامة"], icon: "Settings", group: "settings", groupLabel: "إعدادات", permissionKey: "system.settings", moduleKey: "system", moduleLabel: "النظام", routeKey: "system_settings", order: 25, isOfficialPage: true, isDuplicateAllowed: false, status: "active", defaultEnabled: true },
