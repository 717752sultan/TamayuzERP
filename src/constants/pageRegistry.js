...
export const pageRegistry = [
  ...
  { key: "hr_approvals", label: "الموافقات", aliases: ["الاعتمادات"], icon: "BadgeCheck", group: "hr", groupLabel: "موارد بشرية", permissionKey: "approvals", moduleKey: "approvals", order: 122, isOfficialPage: true, isDuplicateAllowed: false },
  ...
  { key: "hr_settings_full", label: "إعدادات", aliases: ["إعدادات الموارد البشرية"], icon: "Settings", group: "settings", groupLabel: "إعدادات", permissionKey: "hr_settings_full", moduleKey: "hr_settings_full", order: 124, isOfficialPage: true, isDuplicateAllowed: true },
  { key: "hr_financial_setup", label: "تهيئة المعلومات المالية", aliases: ["الإعداد المالي"], icon: "CircleDollarSign", group: "financial", groupLabel: "مالية", permissionKey: "financial_setup", moduleKey: "financial_setup", order: 125, isOfficialPage: true, isDuplicateAllowed: false },
  { key: "hr_templates_full", label: "القوالب", aliases: ["قوالب الموارد البشرية"], icon: "ClipboardList", group: "settings", groupLabel: "إعدادات", permissionKey: "hr_templates_full", moduleKey: "hr_templates_full", order: 126, isOfficialPage: true, isDuplicateAllowed: true },
