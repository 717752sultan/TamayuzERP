...
const navigationMetadata = {
  ...
  performance_kpi_scores: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 7},
  kpi_settings: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 8},
  productivity: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 9},
  incentives: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 10},
  top: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 14},
  plans: { navGroupKey: "hr_performance", navGroupLabel: "الأداء والحوافز", navGroupOrder: 6, navItemOrder: 15},
...
export const pageRegistry = [
  ...
  { key: "attendance_dashboard", label: "لوحة حساب الدوام", aliases: ["حساب الدوام"], icon: "Clock3", group: "hr", groupLabel: "موارد بشرية", permissionKey: "attendance_dashboard", moduleKey: "attendance", order: 107, isOfficialPage: true, isDuplicateAllowed: false, status: "active" },
