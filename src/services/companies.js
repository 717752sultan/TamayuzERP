...
const companyToDb = (company = {}) => {
  ...
  return {
    ...
    accent_color: String(company.accent_color || "#991b1b"),
    sidebar_bg_color: String(company.sidebar_bg_color || "#111827"),
    sidebar_text_color: String(company.sidebar_text_color || "#ffffff"),
    button_color: String(company.button_color || company.primary_color || "#991b1b"),
    button_text_color: String(company.button_text_color || "#ffffff"),
    card_accent_color: String(company.card_accent_color || "#fee2e2"),
    table_header_color: String(company.table_header_color || "#f8fafc"),
    report_header_color: String(company.report_header_color || company.primary_color || "#8b1e1e"),
    theme_mode: String(company.theme_mode || "light"),
    theme_name: String(company.theme_name || "default"),
